...
const Card = ({id, cardnumber, cardname, valid, ccv, vendor, handleDeleteCard }) => {   
    ...
    return(
        <div className={`${isActive ? "flex card active" : "flex card inactive"}`}>
                    ...
                    <div className='flex top'>
                        ...
                        <span className='flex vendor'>{vendor}</span> 
                        <div className='flex handledelete' onClick={ () => handleDeleteCard(id)}>❌</div>
                    </div>

                    <span className='flex cardnumber'>{cardnumber}</span>                  
                    ...
                    <div className='flex low'>
                        ...
                        <div className='flex low-bot'>
                            <span className='flex cardname'>{cardname}</span>                       
                            <span className='flex valid'>{valid}</span> 
                        </div>
                    ...
                    <span className='flex ccv'>{ccv}</span>
